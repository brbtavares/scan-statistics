...
fn main() {
    ...
    for i in 1..14 {
        for j in 1..14 {
            ...
            println!("The expectation of the region {} is {}, the number of cases is {} and its centroid is ({},{})...{}", v[k].idx, v[k].expectation, v[k].cases, v[k].centroid.x, v[k].centroid.y, v[k].is_cluster);
            k = k + 1;
        }
    }
